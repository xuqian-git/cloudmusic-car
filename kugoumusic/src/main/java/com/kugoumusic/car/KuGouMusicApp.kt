...
class KuGouMusicApp : Application(), ImageLoaderFactory {
    override fun onCreate() {
        super.onCreate()
        check(ContainerGate.isPaopaoGuest(this)) { "KuGouMusic must run inside Paopao Desktop" }
        KuGouMusicClient.init(this)
        Settings.init(this)
